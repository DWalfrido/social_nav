python -u -m habitat_baselines.run \
           ...
           habitat_baselines.tensorboard_dir=checkpoints/pruebas_estabilidad \
           habitat_baselines.video_dir=checkpoints/pruebas_estabilidad/video \
           habitat_baselines.checkpoint_folder=checkpoints/pruebas_estabilidad \
           habitat_baselines.eval_ckpt_path_dir=checkpoints/pruebas_estabilidad \
